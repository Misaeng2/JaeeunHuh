 ...
 */
(function(a){
    a.fn.scroller_roll1=function(p){
        var p=p||{};
        ...
        var n=p&&p.images_height?p.images_height:"80";
    ...
    a.fn.scroller_roll2=function(p){
        var p=p||{};
        ...
        m=parseInt(m);
        y.children("ul").children("li").css("width",m+"px");
        y.children("ul").children("li").css("margin-right",i_m+"px");
        y.children("ul").children("li").children("a").css("color",q);
        y.children("ul").children("li").children("a").css("font-size",o);
        y.hover(function(){
            stop()
        ...
        function begin(){
            ...
            y.children("ul").clone().prependTo(y);
            j=parseInt(j);
            y.children("ul").css("right","0px");
            y.find("ul:last").css("right",x);
            w=x-i_m;
            }
            function play(){
            if(parseInt(y.find("ul").eq(t).css("right"))<=-(x)){
                var a=x;
                y.find("ul").eq(t).css("right",a);
                if(t==0){
                    t=1
                    }else{
                    t=0
